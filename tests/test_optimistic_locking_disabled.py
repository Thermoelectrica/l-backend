...
@pytest.mark.asyncio
async def test_defect_update_with_stale_timestamp_when_disabled(
...
@pytest.mark.asyncio
async def test_plant_update_with_stale_timestamp_when_disabled(
    api_client: AsyncClient,
    plant_id,
    facility_id,
    disable_optimistic_locking,
...
@pytest.mark.asyncio
async def test_equipment_update_with_stale_timestamp_when_disabled(
    api_client: AsyncClient,
    equipment_id,
    facility_id,
    plant_id,
...
@pytest.mark.asyncio
async def test_defect_update_with_stale_timestamp_when_enabled(
    api_client: AsyncClient,
    defect_id,
    equipment_id,
):
...
@pytest.mark.asyncio
async def test_force_parameter_still_works_when_locking_enabled(
    api_client: AsyncClient,
    defect_id,
    equipment_id,
):
...
@pytest.mark.asyncio
async def test_defect_update_without_timestamp_when_disabled(
    api_client: AsyncClient,
    defect_id,
    equipment_id,
    disable_optimistic_locking,
